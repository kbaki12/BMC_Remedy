...
Sum(ResponseQ1P+ResponseQ2P+ResponseQ3P) AS_Q3_ytd_Prior,
...
Where
((ResponseQ1P+ResponseQ2P+ResponseQ3P+ResponseQ4P) >0) OR
((ResponseQ1+ResponseQ2+ResponseQ3+ResponseQ4) >0)
GROUP BY
RPTY,
COMPANY,
Media,
